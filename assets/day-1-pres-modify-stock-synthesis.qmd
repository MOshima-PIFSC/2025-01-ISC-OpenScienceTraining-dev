...
::: {.fragment .fade-out fragment-index=2}
::: {.fragment .fade-in fragment-index=1}
::: {.codewindow .r .absolute top="15%" left="30%" right="0%" bottom="30%" style="font-size: 0.6em;"}
ss3-example-calcs.r
```{.r}
# load packages
    library(r4ss)
...
::: {.fragment .fade-in fragment-index=2}
::: {.absolute top="15%" left="30%" right="0%" bottom="0%"}
```{r}
#| echo: true
class(tmp_ctl)
names(tmp_ctl)
...
::: {.fragment .fade-in fragment-index=5}
::: {.codewindow .r .absolute top="15%" left="30%" right="0%" bottom="15%" style="font-size: 0.6em;"}
ss3-example-calcs.r
```{.r}
# load packages
    library(r4ss)
...
::: {.fragment .fade-in fragment-index=1}
::: {.codewindow .r .absolute top="15%" left="30%" right="0%" bottom="40%" style="font-size: 0.6em;"}
ss3-example-calcs.r
```{.r}
...
::: {.fragment .fade-in fragment-index=1}
::: {.codewindow .r .absolute top="15%" left="30%" right="0%" bottom="5%" style="font-size: 0.5em;"}
ss3-example-calcs.r
```{.r}
...
::: {.absolute left=0% top=15% right=40%}
...
::: {.fragment .fade-in fragment-id=1}
::: {.absolute left="65%" right="0%" top="35%" bottom="15%" style="font-color: #ffffff; font-size:1.175em; padding: 0.5em 1em; background-color: #0085CA; box-shadow: 0 0 1rem 0 rgba(0, 0, 0, .5); border-radius: 15px;"}
[Options]{.bg}
</br>
- Growth
</br>
...
::: {.fragment .fade-in fragment-id=2}
::: {.absolute left=0% top=55% right=40%}
